...
class ANTCLIDemo {
    ...
    generateScoresForTarget(target) {
        ...
        const base = baseScores[target] || baseScores[80];
        return {
            scientific_merit: {
                novelty: base.sm,
