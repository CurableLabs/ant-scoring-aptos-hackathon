...
module ant_scoring::clean_ant_scoring {
    ...
    public entry fun score_proposal(
        ...
        data_quality: u8,
        clarity_of_protocol: u8,
        // Community Alignment scores (0-100)
        mission_fit: u8,
        dao_engagement: u8,
        // Resource Efficiency scores (0-100)
        cost_effectiveness: u8,
        agentic_resource_use: u8,
        // Open Science scores (0-100)
        data_protocol_sharing: u8,
        collaborative_potential: u8,
        ...
        // Create structured scores from individual parameters
        let scientific_merit = ScientificMeritScores { novelty, biological_plausibility, prior_evidence };
        let feasibility = FeasibilityScores { technical_viability, data_quality, clarity_of_protocol };
        let community_alignment = CommunityAlignmentScores { mission_fit, dao_engagement };
        let resource_efficiency = ResourceEfficiencyScores { cost_effectiveness, agentic_resource_use };
        let open_science = OpenScienceScores { data_protocol_sharing, collaborative_potential };
